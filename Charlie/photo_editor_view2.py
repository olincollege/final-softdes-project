...
class PhotoView():
    ...
    def GUI(self):
        ...
        var1 = DoubleVar()
        scale = Scale(root, from_=1, to=10, variable=var1,
        ...
        var2 = DoubleVar()
        scale = Scale(root, from_=1, to=10, variable=var2,
                      orient=HORIZONTAL, command=events)
        scale.pack(anchor=CENTER)
        ...
        var3 = DoubleVar()
        scale = Scale(root, from_=1, to=10, variable=var3,
                      orient=HORIZONTAL, command=events)
        scale.pack(anchor=CENTER)
        ...
        var4 = DoubleVar()
        scale = Scale(root, from_=1, to=10, variable=var4,
                      orient=HORIZONTAL, command=events)
        scale.pack(anchor=CENTER)
        ...
        var5 = DoubleVar()
        scale = Scale(root, from_=1, to=10, variable=var5,
                      orient=HORIZONTAL, command=events)
        scale.pack(anchor=CENTER)
        ...
        var6 = DoubleVar()
        scale = Scale(root, from_=0, to=360, variable=var6,
                      orient=HORIZONTAL, command=events)
        scale.pack(anchor=CENTER)
